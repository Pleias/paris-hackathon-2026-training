...
#SBATCH --output=logs/%j_fp8.out
#SBATCH --error=logs/%j_fp8.err
...
srun python -m torch.distributed.run \
    ...
    /home/pleias/yarik-slope/ai_slope/fp8-train/train.py \
        --data_dir      /home/data/ \
        --checkpoint_path /home/pleias/yarik-slope/ai_slope/fp8-train/checkpoint.pt \
        --vocab_size    32000 \
        --max_steps     50 \
        --time_limit_min 8
