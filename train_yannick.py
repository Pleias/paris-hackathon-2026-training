...
try:
    ...
    sync_float8_amax_and_scale_history = None

from torch.distributed import init_process_group, destroy_process_group
import torch.distributed as dist

from model_yannick import get_model
...
def main():
    ...
    setup_attention_backend(device=device, master=master, require_fa4=args.require_fa4)
